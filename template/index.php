...
<h1 class="text-center text-secondary py-2">CONTACT FORM  MESSAGES</h1>
<h4 class="text-center  my-5">ShortCode is <span class="text-secondary">[Contact_Form]</span></h4>
